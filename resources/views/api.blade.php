        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav slide-nav">
                    <li><a id="index" href="/index">volver</a></li>
                  
            </div><!--/.nav-collapse -->
        </div>
    </nav>
    <h1 class="h1API">Fanáticos de la velocidad</h1>

    <div id="resultado" class="grid_parent">
    </div>
    <script type="text/javascript" src="js/scriptAPI.js"></script>
